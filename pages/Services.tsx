    ...
    <div className="bg-black min-h-screen">
        ...
        <div className="max-w-6xl mx-auto reveal">
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center gap-6 mb-20">
            <button 
              ...
              className={`w-full sm:w-[320px] px-10 py-7 rounded-2xl text-[11px] font-black uppercase tracking-raw transition-all border-2 ${
                activeTab === 'ea' 
      ...
      {activeTab === 'ea' ? (
        <>
          ...
          <section className="py-40 bg-[#ab7e31]/5 border-y border-white/5">
            <div className="max-w-7xl mx-auto px-4 text-center">
              <h2 className="text-4xl md:text-6xl logo-font font-black text-white mb-20 uppercase tracking-tighter">STRATEGIC <span className="text-[#ab7e31] italic font-light lowercase">Investment</span></h2>
        ...
        <>
          ...
          <section className="py-40 bg-[#ab7e31]/5 border-y border-white/5">
            <div className="max-w-7xl mx-auto px-4 text-center">
              <h2 className="text-4xl md:text-6xl logo-font font-black text-white mb-20 uppercase tracking-tighter">FINANCIAL <span className="text-[#ab7e31] italic font-light lowercase">Investment</span></h2>
